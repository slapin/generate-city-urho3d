class RoadRect {
    ...
    Array<RoadRect> split2r(float d)
    {
        RoadRect a1, a2;
        Array<RoadRect> ret;
        a1.left = left;
    ...
    Array<RoadRect> split2l(float d)
    {
        RoadRect a1, a2;
        Array<RoadRect> ret;
        a1.left = left;
    ...
    Array<RoadRect> split2t(float d)
    {
        RoadRect a1, a2;
        Array<RoadRect> ret;
        a1.left = left;
    ...
    Array<RoadRect> split2b(float d)
    {
        RoadRect a1, a2;
        Array<RoadRect> ret;
        a1.left = left;
    ...
    RoadRect(float l, float t, float r, float b)
    {
        left = l;
        top = t;
        right = r;
